...
const scripts = [
  ...
  ...rootTestFiles.map((file) => ({ name: file, expectExit: 0 })),
  { name: 'web/test-clean-chips.mjs', expectExit: 0 },
  { name: 'web/test-enrich-salary.mjs', expectExit: 0 },
  { name: 'web/test-render-utils.mjs', expectExit: 0 },
